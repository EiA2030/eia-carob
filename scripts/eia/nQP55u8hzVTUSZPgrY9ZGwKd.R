...
"
  ...
  #   time = as.POSIXct(as.numeric(r1$`_submission_time`[2:length(r1$`_submission_time`)]) * (60*60*24), origin="1899-12-30", tz="UTC")
  # )
  ...
  # d2 <- d2[tapply(1:nrow(d2), d2[c(1,3)], function(ii) ii[which.max(d2$time[ii])]),]
  # d2 <- d2[!duplicated(d2) & complete.cases(d2),]
  # d2$time <- NULL
  # 
  ...
  #   # fwy_residue_p1A = (as.numeric(r2$`harvest_1a/soy_fresh_biomass_g_1A`[2:length(r2$`harvest_1a/soy_fresh_biomass_g_1A`)]) / (as.numeric(r2$`layout_p1A/plot_area_p1_A`[2:length(r2$`layout_p1A/plot_area_p1_A`)]))) * 10000,
  #   # fw_yield_p1A = (as.numeric(r2$`harvest_1a/soy_fresh_w_pod_g_1A`[2:length(r2$`harvest_1a/soy_fresh_w_pod_g_1A`)]) / (as.numeric(r2$`layout_p1A/plot_area_p1_A`[2:length(r2$`layout_p1A/plot_area_p1_A`)]))) * 10000,
  ...
  #   # fwy_residue_p1B = (as.numeric(r2$`harvest_1b/soy_fresh_biomass_g_1B`[2:length(r2$`harvest_1b/soy_fresh_biomass_g_1B`)]) / (as.numeric(r2$`layout_p1B/plot_area_p1_B`[2:length(r2$`layout_p1B/plot_area_p1_B`)]))) * 10000,
  #   # fw_yield_p1B = (as.numeric(r2$`harvest_1b/soy_fresh_w_pod_g_1B`[2:length(r2$`harvest_1b/soy_fresh_w_pod_g_1B`)]) / (as.numeric(r2$`layout_p1B/plot_area_p1_B`[2:length(r2$`layout_p1B/plot_area_p1_B`)]))) * 10000,
  ...
  #   # fwy_residue_p1C = (as.numeric(r2$`harvest_1c/soy_fresh_biomass_g_1C`[2:length(r2$`harvest_1c/soy_fresh_biomass_g_1C`)])  / (as.numeric(r2$`layout_p1C/plot_area_p1_C`[2:length(r2$`layout_p1C/plot_area_p1_C`)]))) * 10000,
  #   # fw_yield_p1C = (as.numeric(r2$`harvest_1c/soy_fresh_w_pod_g_1C`[2:length(r2$`harvest_1c/soy_fresh_w_pod_g_1C`)])  / (as.numeric(r2$`layout_p1C/plot_area_p1_C`[2:length(r2$`layout_p1C/plot_area_p1_C`)]))) * 10000,
  ...
  #   # fwy_residue_p2 = (as.numeric(r2$`harvest_2/soy_fresh_biomass_g_2`[2:length(r2$`harvest_2/soy_fresh_biomass_g_2`)]) / as.numeric(r2$`layout_p2/plot_area_p2`[2:length(r2$`layout_p2/plot_area_p2`)])) * 10000,
  #   # fw_yield_p2 = (as.numeric(r2$`harvest_2/soy_fresh_w_pod_g_2`[2:length(r2$`harvest_2/soy_fresh_w_pod_g_2`)]) / as.numeric(r2$`layout_p2/plot_area_p2`[2:length(r2$`layout_p2/plot_area_p2`)])) * 10000,
  #   fwy_residue_p2 = as.numeric(r2$`harvest_2/soy_fresh_biomass_g_2`[2:length(r2$`harvest_2/soy_fresh_biomass_g_2`)]),
  #   fw_yield_p2 = as.numeric(r2$`harvest_2/soy_fresh_w_pod_g_2`[2:length(r2$`harvest_2/soy_fresh_w_pod_g_2`)]),
  ...
  #   # fwy_residue_p3 = (as.numeric(r2$`harvest_3/soy_fresh_biomass_g_3`[2:length(r2$`harvest_3/soy_fresh_biomass_g_3`)]) / as.numeric(r2$`layout_p3/plot_area_p3`[2:length(r2$`layout_p3/plot_area_p3`)])) * 10000,
  #   fwy_residue_p3 = as.numeric(r2$`harvest_3/soy_fresh_biomass_g_3`[2:length(r2$`harvest_3/soy_fresh_biomass_g_3`)]),
  #   # fw_yield_p3 = (as.numeric(r2$`harvest_3/soy_fresh_w_pod_g_3`[2:length(r2$`harvest_3/soy_fresh_w_pod_g_3`)]) / as.numeric(r2$`layout_p3/plot_area_p3`[2:length(r2$`layout_p3/plot_area_p3`)])) * 10000,
  #   fw_yield_p3 = as.numeric(r2$`harvest_3/soy_fresh_w_pod_g_3`[2:length(r2$`harvest_3/soy_fresh_w_pod_g_3`)]),
  ...
  # 
  # # (d3p$fw_yield[grep("ZM", d3p$trial_id, fixed = TRUE) & d3p$treatment == "Standardized Farmer Practices"] / 10) * 10000
  # # (d3p$fw_yield[grep("ZM", d3p$trial_id, fixed = TRUE) & d3p$treatment == "MVP"] / 10) * 10000
  # 
  # # grep("ZM", ifelse(is.na(r2[[8]][2:length(r2[[8]])]), r2[[9]][2:length(r2[[9]])], r2[[8]][2:length(r2[[8]])]), fixed = TRUE)
  # 
  # # # Fix wrong value
  # # d3p$fw_yield[d3p$fw_yield > 10] <- d3p$fw_yield[d3p$fw_yield > 10]/10
  # 
  # d2 <- merge(d2[,colnames(d2)[!(colnames(d2) %in% c("plot_name"))]], d3p[,colnames(d3p)[!(colnames(d3p) %in% c("plot_name"))]], c("trial_id", "treatment"))
  # 
  # # # Standardize to units (some are ton, other are kg...)
  # # d2$fw_yield1 <- (ifelse(d2$plot_area > 100, d2$fw_yield, d2$fw_yield)/(d2$plot_area)) * 10000
  # # d2$fw_yield <- ((d2$fw_yield)/d2$plot_area) * 10000
  # # d2$fw_yield <- ((d2$fwy_residue)/d2$plot_area) * 10000
  # 
