...
"
  ...
  d1 <- data.frame(
    ...
    longitude = round(as.numeric(r1[[14]][2:length(r1[[14]])]), 3),
    latitude = round(as.numeric(r1[[13]][2:length(r1[[13]])]), 3),
  ...
  d2p <- data.frame(
    ...
    row_spacing_p1 = as.numeric(r1$`planting_p1/row_spacing_p1`[2:length(r1$`planting_p1/row_spacing_p1`)]),
    plant_spacing_p1 = as.numeric(r1$`planting_p1/plant_spacing_p1`[2:length(r1$`planting_p1/plant_spacing_p1`)]),
