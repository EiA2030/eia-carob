...
"
  ...
  d2p <- data.frame(
    ...
    K_fertilizer_p2 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_2/mop_amount_p2`[2:length(r11$`group_fertilizer_2/mop_amount_p2`)]) * 0.21,
                                               ...
                                               as.integer(r11$`group_fertilizer_2/new_yara_legume_amount_p2`[2:length(r11$`group_fertilizer_2/new_yara_legume_amount_p2`)]) * 0.04)),
                              na.rm = TRUE),
    fertilizer_price_p2 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_2/soa_amount_p2`[2:length(r11$`group_fertilizer_2/soa_amount_p2`)]) * (as.integer(r11$`group_price/soa_price`[2:length(r11$`group_price/soa_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_2/yaramila_croplift_bio_amount_p2`[2:length(r11$`group_fertilizer_2/yaramila_croplift_bio_amount_p2`)]) * (as.integer(r11$`group_price/yaramila_croplift_bio_price`[2:length(r11$`group_price/yaramila_croplift_bio_price`)])/50), # https://www.yara.com/crop-nutrition/our-global-fertilizer-brands/yaramila/
                                                   as.integer(r11$`group_fertilizer_2/mop_amount_p2`[2:length(r11$`group_fertilizer_2/mop_amount_p2`)]) * (as.integer(r11$`group_price/mop_price`[2:length(r11$`group_price/mop_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_2/new_yara_legume_amount_p2`[2:length(r11$`group_fertilizer_2/new_yara_legume_amount_p2`)]) * (as.integer(r11$`group_price/new_yara_legume_price`[2:length(r11$`group_price/new_yara_legume_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_2/nodulmax_plus_amount_p2`[2:length(r11$`group_fertilizer_2/nodulmax_plus_amount_p2`)]) * (as.integer(r11$`group_price/nodulmax_plus_price`[2:length(r11$`group_price/nodulmax_plus_price`)])/0.1))),
                                  na.rm = TRUE),
    ...
    K_fertilizer_p3 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_3/mop_amount_p3`[2:length(r11$`group_fertilizer_3/mop_amount_p3`)]) * 0.21,
                                               ...
                                               as.integer(r11$`group_fertilizer_3/new_yara_legume_amount_p3`[2:length(r11$`group_fertilizer_3/new_yara_legume_amount_p3`)]) * 0.04)),
                              na.rm = TRUE),
    fertilizer_price_p3 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_3/soa_amount_p3`[2:length(r11$`group_fertilizer_3/soa_amount_p3`)]) * (as.integer(r11$`group_price/soa_price`[2:length(r11$`group_price/soa_price`)])/50),
                                                   ...
                                                   as.integer(r11$`group_fertilizer_3/mop_amount_p3`[2:length(r11$`group_fertilizer_3/mop_amount_p3`)]) * (as.integer(r11$`group_price/mop_price`[2:length(r11$`group_price/mop_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_3/new_yara_legume_amount_p3`[2:length(r11$`group_fertilizer_3/new_yara_legume_amount_p3`)]) * (as.integer(r11$`group_price/new_yara_legume_price`[2:length(r11$`group_price/new_yara_legume_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_3/nodulmax_plus_amount_p3`[2:length(r11$`group_fertilizer_3/nodulmax_plus_amount_p3`)]) * (as.integer(r11$`group_price/nodulmax_plus_price`[2:length(r11$`group_price/nodulmax_plus_price`)])/0.1))),
                                  na.rm = TRUE),
    ...
    K_fertilizer_p4 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_4/mop_amount_p4`[2:length(r11$`group_fertilizer_4/mop_amount_p4`)]) * 0.21,
                                               ...
                                               as.integer(r11$`group_fertilizer_4/new_yara_legume_amount_p4`[2:length(r11$`group_fertilizer_4/new_yara_legume_amount_p4`)]) * 0.04)),
                              na.rm = TRUE),
    fertilizer_price_p4 = rowSums(data.frame(cbind(as.integer(r11$`group_fertilizer_4/soa_amount_p4`[2:length(r11$`group_fertilizer_4/soa_amount_p4`)]) * (as.integer(r11$`group_price/soa_price`[2:length(r11$`group_price/soa_price`)])/50),
                                                   ...
                                                   as.integer(r11$`group_fertilizer_4/mop_amount_p4`[2:length(r11$`group_fertilizer_4/mop_amount_p4`)]) * (as.integer(r11$`group_price/mop_price`[2:length(r11$`group_price/mop_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_4/new_yara_legume_amount_p4`[2:length(r11$`group_fertilizer_4/new_yara_legume_amount_p4`)]) * (as.integer(r11$`group_price/new_yara_legume_price`[2:length(r11$`group_price/new_yara_legume_price`)])/50),
                                                   as.integer(r11$`group_fertilizer_4/nodulmax_plus_amount_p4`[2:length(r11$`group_fertilizer_4/nodulmax_plus_amount_p4`)]) * (as.integer(r11$`group_price/nodulmax_plus_price`[2:length(r11$`group_price/nodulmax_plus_price`)])/0.1))),
                                  na.rm = TRUE)
  )
